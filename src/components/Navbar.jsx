    ...
    <>
      <Navbar expand="lg" className="bg-dark text-light py-2">
        <Container fluid>
          <Navbar.Brand href="/" className="ms-3 text-light fw-bold fs-3 d-flex align-items-center">
            <img
              alt=""
              src="https://dlaqljgi7pm30.cloudfront.net/images/3cigywyc8q7o/i7mgfwbbsnik/C141E24D-578C-40A8-8381-93A38414EF20.jpeg?v=20230109142559"
              width="45"
              height="35"
          ...
          <Navbar.Collapse id="navbarScroll" className="justify-content-end me-4 mt-3">
              ...
              {isAuthenticated ? (
                <>
                  <Dropdown align="end">
                    ...
                    >
                      <img
                        src={currentUser.profileImage || `https://ui-avatars.com/api/?name=${currentUser.name}&background=660ff1&color=fff`}
                    ...
                    <Dropdown.Menu className="shadow-sm">
                      ...
                      {currentUser.role === 'admin' && (
                        <Dropdown.Item as={Link} to="/dashboard">
                          <FaCog className="me-2" />Dashboard
                        </Dropdown.Item>
                      )}
                      <Dropdown.Divider />
                ...
                <>
                  <Link to="/login" className="sign-in mx-3 text-decoration-none text-light">Sign In</Link>
                  <Link 
                    to="/signup" 
                    className="header-button text-decoration-none" 
                    style={{ backgroundColor: '#660ff1', color: 'white', border: 'none', padding: '8px 16px', borderRadius: '4px' }}
                  >
                    Get Started
                  </Link>
                </>
      ...
      <Navbar bg="dark" data-bs-theme="dark">
        <Nav className="m-auto">
          ...
          <Nav.Link href="/appointment" className="text-light me-3">Book Appointment</Nav.Link>
          <Nav.Link href="/resources" className="text-light me-3">Resources</Nav.Link>
          <Nav.Link as={Link} to="/blog" className="text-light me-3">Blog & News</Nav.Link>
