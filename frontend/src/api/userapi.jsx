...
const loginUser = (credentials) =>{ 
  const res = axios.post("http://localhost:8000/auth/jwt/create", credentials);
  const resUser = axios.get("http://localhost:8000/auth/users/me", { headers: { Authorization: `Bearer ${res.data.access}` } });
  return resUser.data;}
